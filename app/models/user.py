...
class User(Base):
    ...
    #
    # ОКРЕМО від provides_services: це різні речі. Майстер може приймати
    # записи, але не хотіти бути на вітрині - або навпаки, бути обличчям
    # закладу, не ведучи власного розкладу. Одне поле на дві потреби
    # змушувало б вимикати прийом записів заради приховування з сайту.
    show_in_storefront = Column(Boolean, default=True, nullable=False)
