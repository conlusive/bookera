...
class Business(Base):
    ...
    # геокодування адреси, бо вхід буває з двору, а будинок довгий.
    #
    # Numeric, а не Float: у float 49.8397 зберігається як
    # 49.83970000000001, і порівняння координат дає хибні результати.
    # 7 знаків після коми - точність близько сантиметра, більше
    # не має сенсу.
