...
/>
      ...
      {/* ДЛЯ БІЗНЕСУ - сцена на весь екран.
          Інша аудиторія й інше питання, тому різка зміна сцени:
          темне тло, кабінет, що виринає. Кабінет - точна копія
          справжнього, щоб зареєстрований власник його впізнав. */}
      <BusinessShowcase />
